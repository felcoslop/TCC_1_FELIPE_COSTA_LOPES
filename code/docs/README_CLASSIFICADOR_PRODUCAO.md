...
```bash
# Classificar período específico (formato: "YYYY-MM-DD HH:MM:SS" - Horário de Brasília)
python scripts/classificador_producao.py \
...
| `--inicio` | String | - | Data/hora de início em **horário de Brasília GMT-3** (formato: "YYYY-MM-DD HH:MM:SS") |
| `--fim` | String | - | Data/hora de fim em **horário de Brasília GMT-3** (formato: "YYYY-MM-DD HH:MM:SS") |
...
- Se não encontrar dados, verifique se o horário informado está correto (considere a conversão UTC)
