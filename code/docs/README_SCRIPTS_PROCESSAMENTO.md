...
- **Resiliência Windows**: Tratamento automático de encoding (UTF-8/CP1252) para evitar crashes em sistemas brasileiros.
- **Detecção de Erros**: Relatórios descritivos no console para facilitar depuração.
- **Thresholds Dinâmicos**: Carregamento automático de parâmetros reais do equipamento.
...
### **5. Limpeza Inteligente de Outliers e Filtro EMI**
- **Método**: Limites físicos do sistema + IQR Avançado.
- **Filtro EMI**: Zero automático de RPM se Corrente < 5% do P90, evitando "phantom signals".
