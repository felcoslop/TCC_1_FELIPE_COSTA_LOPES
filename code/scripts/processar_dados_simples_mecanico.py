...
def processar_periodo_worker(args):
    ...
    try:
        ...
        # Criar flag de interpolação antes de preencher os valores
        # Se 'object_temp' for NaN, significa que o timestamp foi gerado pela resamplagem (é um gap)
        df_merged['interpolado'] = df_merged['object_temp'].isna()
