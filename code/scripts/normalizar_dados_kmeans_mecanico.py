...
def carregar_dados(mpoint=None, intervalo_arquivo=None):
    ...
    dir_uniao = raw_preenchido_dir(mpoint)
...
def criar_visualizacoes(dados_normalizados, colunas_validas, df_original, args):
    ...
    dir_resultados = results_dir(args.mpoint, create=True)
    caminho_plot = dir_resultados / f'dados_normalizados_analise_{args.mpoint}_mecanico.png'
