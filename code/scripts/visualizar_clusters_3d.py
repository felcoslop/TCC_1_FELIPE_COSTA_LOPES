...
def plotar_3d(df_dados, mpoint=None):
    ...
    output1 = dir_resultados / f'estados_corrente_vibracao_tempo_3d{"_" + mpoint if mpoint else ""}.png'
    ...
    from utils.artifact_paths import results_dir
    dir_resultados = results_dir(mpoint, create=True) if mpoint else DIR_RESULTS
    output2 = dir_resultados / f'estados_{nome_eixo}_vibracao_tempo_3d{"_" + mpoint if mpoint else ""}.png'
