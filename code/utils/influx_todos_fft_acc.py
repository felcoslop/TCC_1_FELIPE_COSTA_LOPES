...
port = 8086
database = "aihub"
measurement = "validated_fft_acc"
retention_policy = "autogen"

print("🚀 Iniciando exportação de dados do InfluxDB (validated_fft_acc)...")
...
for i, mp in enumerate(mpoints, start=1):
    filename = f"dados_fft_mag_{mp}.csv"
    ...
    try:
        registros = future.result(timeout=1000)  # timeout de 400s
