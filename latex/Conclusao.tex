...
Os arquivos brutos necessários para o treinamento, incluindo os arquivos \texttt{.csv} e o arquivo \texttt{.env} com as credenciais do InfluxDB, estão disponíveis no seguinte link do OneDrive:
...
O visualizador interativo das séries temporais classificadas está disponível publicamente na web no seguinte endereço:

\href{https://evolution-tcc-felipe-costa-lopes-visualizador.hfzba0.easypanel.host/}{\textbf{Acessar} visualizador das séries temporais classificadas}
\vspace{0.4cm}
